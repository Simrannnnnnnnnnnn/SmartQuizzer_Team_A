...
* [🏗️ System Architecture](#-system-architecture)
    ...
    * [⚙️ Quiz Generation Pipeline](#-quiz-generation-pipeline)
* [🧠 Adaptive Learning Engine](#-adaptive-learning-engine)
    * [🔧 How It's Enabled](#-how-its-enabled)
    * [🔢 Adaptation Algorithm](#-adaptation-algorithm)
    * [🔄 Adaptive Flow Diagram](#-adaptive-flow-diagram)
* [🔬 Difficulty Calculation & Feature Logic](#-difficulty-calculation--feature-logic)
    * [📐 The Formula ($K_c$)](#-the-formula)
    * [🛠️ Adaptive Feature Integration](#-adaptive-feature-integration)
    * [⚙️ Evaluation Weightage Matrix](#-evaluation-weightage-matrix)
* [🗺️ User Journey & Experience Map](#-user-journey--experience-map)
* [🖥️ Screen-by-Screen Breakdown](#-screen-by-screen-breakdown)
    * [🚀 Landing & Onboarding Screens](#-landing-screen-current-implementation)
    * [⚙️ Quiz & Library Configuration](#-quiz--library-screen-breakdown)
    * [⚡ AI Study Hub Interface](#-ai-study-hub-screen)
* [🏗️ Layout Component Architecture](#-layout-component-architecture)
* [📊 Result Screen & Analytics Breakdown](#-result-screen-breakdown)
    * [📈 Learning Analytics Logic](#-learning-analytics-logic)
* [🔬 AI Evaluation System](#-ai-evaluation-system)
    * [📏 Evaluation Criteria Matrix](#-evaluation-criteria-matrix)
    * [💹 Scoring Tier Logic](#-scoring-tier-logic)
...
* [📊 Performance Tracking Dashboard](#-learning-analytics--performance-tracking)
    * [🕸️ Multi-Dimensional Mastery Radar](#-multi-dimensional-mastery-radar)
